...
#### ❓ 퀴즈 탭 (객관식)
- 학습 내용을 점검하는 객관식 문제 5개
- 4지선다 형식으로 즉각적인 피드백 제공

**사용 방법**:
1. 문제를 읽습니다
2. 4개의 선택지 중 정답을 선택합니다
3. 모든 문제를 풀고 "제출" 버튼을 클릭합니다
4. 즉시 채점 결과와 해설이 표시됩니다

**결과 확인**:
- **점수**: 5문제 중 맞춘 개수 표시 (예: 4/5)
- **해설**: 각 문제의 정답 및 설명 확인
- **재시도**: "다시 풀기" 버튼으로 퀴즈 재도전 가능

#### 🎓 고급 학습 탭 (주관식)
- 심화 학습을 위한 주관식 문제 3개
- AI가 답변을 채점하고 상세한 피드백 제공

**사용 방법**:
1. 문제를 읽습니다
2. 텍스트 박스에 답변을 작성합니다 (자유 형식)
3. "✓ 채점하기" 버튼을 클릭합니다
4. 약 5~10초 후 AI 채점 결과가 표시됩니다
